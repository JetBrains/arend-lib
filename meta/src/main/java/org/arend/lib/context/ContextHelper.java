...
public class ContextHelper implements Context {
  ...
  public List<CoreBinding> getAdditionalBindings(ExpressionTypechecker typechecker) {
    return meta instanceof UsingMeta || meta == null ? UsingMeta.getNewBindings(argument, typechecker, meta == null || ((UsingMeta) meta).keepOldContext) : context.getAdditionalBindings(typechecker);
  }
}
