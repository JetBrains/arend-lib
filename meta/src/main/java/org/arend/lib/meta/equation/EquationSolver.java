...
public interface EquationSolver {
  ...
  @Nullable Utils.Maybe<CoreExpression> getEqType(@Nullable TypedExpression leftExpr, @Nullable TypedExpression rightExpr); // the type of equality between two expressions
